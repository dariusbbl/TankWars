...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
			...
			VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.5, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.8, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.4, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.3, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.9, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
	...
	{
		VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.5, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.8, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.4, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
	};
    ...
    {
        // 2 triangles with opposing vertex orientations
        VertexFormat(glm::vec3(0, 0 , 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.5, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.8, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.4, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    //RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-0.5f, 0.9f, 0.5), glm::vec3(0.25f));
    // TODO(student): Draw the mesh that was created with `CreateMesh()`

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-0.5f, 0.9f, 0.5), glm::vec3(0.25f));
    // TODO(student): Draw the square
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0.5f, 0.9f, 0.5), glm::vec3(0.25f));
