...
void Lab5::OnInputUpdate(float deltaTime, int mods)
{
	...
	//comenzi de modificare a fov-ului (zoom in si zoom out)
    float fov = 60.0f;
	...
	//comenzi de modificare a latimii si inaltimii ferestrei de proiectie in cazul proiectiei ortografice
