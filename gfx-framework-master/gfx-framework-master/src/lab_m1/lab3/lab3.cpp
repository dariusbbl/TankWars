...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    modelMatrix *= transform2D::Translate(150 + translateX, 250);
    ...
    scaleX += sin(deltaTimeSeconds) * 1;  
    scaleY += sin(deltaTimeSeconds) * 1;
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(650, 250); 
    modelMatrix *= transform2D::Scale(1 + scaleX, 1 + scaleY);
	modelMatrix *= transform2D::Translate(-cx, -cy);
